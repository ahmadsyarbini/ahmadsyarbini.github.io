...
6. type `clean`. %#ff0004%(This is permanent and irreversible. Check closely with `detail disk`. If still not confident, shut down and remove drives that you don't want to reformat, and start over.)%%
