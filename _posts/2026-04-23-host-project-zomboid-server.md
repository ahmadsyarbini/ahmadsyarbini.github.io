...
```batch
steamcmd.exe +force_install_dir "%directory%" +login anonymous +app_update 380870 -beta "42.13.1" validate +quit
```
4. Replace `%directory%` with your own folder path. Replace `-beta "42.13.1"` with your own beta selection or delete it.
